...
<div class="author wshk-tab" id="div-wshk-news">
    ...
    <div class="wshkpagewhitebg">
        ...
        <div class="boxwshknotify newnotify">
            ...
            <h2 class="wshknewsboxtitle"><span class="newsicons dashicons dashicons-bell"></span> <?php esc_html_e( 'WHAT DOES WOO SHORTCODES KIT V.2.0.1 INCLUDE?', 'woo-shortcodes-kit' ); ?>
            </h2>
        
            <p class="wshknewsboxdesc">
                
                <?php esc_html_e( 'Version 2.0.1 includes new fixes and some updates.', 'woo-shortcodes-kit' ); ?>
            
            <br>
            
                <?php esc_html_e( 'Also is ready to work with the new WordPress v.5.9.2 and WooCommerce v.6.3.1', 'woo-shortcodes-kit' ); ?>
            </p>
        
            <br>
        
            <a class="wshknewsboxbutton" href="https://disespubli.com/docs/wshk-v-2-0-1/" target="_blank"><?php esc_html_e( 'Read More', 'woo-shortcodes-kit' ); ?>
            </a>
        ...
        <div class="boxwshknotify newnotify">
            ...
            <h2 class="wshknewsboxtitle"><span class="newsicons dashicons dashicons-bell"></span> <?php esc_html_e( 'NEW UPDATE FOR WSHK PRO - V.1.1.8 ', 'woo-shortcodes-kit' ); ?>
            </h2>
        
            <p class="wshknewsboxdesc">
                
                <?php esc_html_e( 'The version 1.1.8 includes some updates and fixes.', 'woo-shortcodes-kit' ); ?>
                
            <br>
            
                <?php esc_html_e( 'Also works correctly with Woo Shortcodes Kit v.2.0.1, WordPress v.5.9.2 and WooCommerce v.6.3.1', 'woo-shortcodes-kit' ); ?>    
            
            </p>
            
            <br>
            
            <a class="wshknewsboxbutton" href="https://disespubli.com/docs/wshk-pro-v-1-1-8/" target="_blank"><?php esc_html_e( 'Read More', 'woo-shortcodes-kit' ); ?>
            </a>
